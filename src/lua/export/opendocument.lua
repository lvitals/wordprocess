...
local style_tab=
{
	...
	["N"] =  {false, simple(), emit('</text:p>') },
	["C"] =  {false, simple(), emit('</text:p>') },
...
,
			...
			<office:automatic-styles>
				<style:page-layout style:name="WordProcessPage">
					<style:page-layout-properties
						fo:page-width="%scm" fo:page-height="%scm"
						fo:margin-top="%scm" fo:margin-right="%scm"
						fo:margin-bottom="%scm" fo:margin-left="%scm"/>
				</style:page-layout>
			</office:automatic-styles>
			<office:master-styles>
				<style:master-page style:name="Standard"
					style:page-layout-name="WordProcessPage"/>
			</office:master-styles>
	]], layout.pageWidthCm, layout.pageHeightCm,
		layout.marginTopCm, layout.marginRightCm,
	...
	xml["styles.xml"] = xml["styles.xml"]:gsub(
		'<style:text%-properties style:font%-name="serif"/>',
		'<style:text-properties style:font-name="serif" fo:font-size="'..
		tostring(layout.fontSizePt)..'pt"/>', 1)
	xml["styles.xml"] = xml["styles.xml"]:gsub(
		'fo:margin%-left="10mm"/>',
