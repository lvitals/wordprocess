...
local style_tab =
{
	...
	["N"] =  {pre=false, list=false,
		on='<p class="note">', off='</p>'},
	["C"] =  {pre=false, list=false,
		on='<p class="caption">', off='</p>'},
...
local function callback(writer, document)
	...
	return ExportFileUsingCallbacks(document,
	{
		prologue = function()
			...
			writer('<meta name="generator" content="WordProcess '..VERSION..'"/>\n')
			writer('<title>', unhtml(document.name), '</title>\n')
			writer('<style>\n@page { size: ', tostring(layout.pageWidthCm), 'cm ',
				tostring(layout.pageHeightCm), 'cm; margin: ', tostring(layout.marginTopCm), 'cm ',
				tostring(layout.marginRightCm), 'cm ', tostring(layout.marginBottomCm), 'cm ',
				tostring(layout.marginLeftCm), 'cm; }\n')
			writer('body { font-size: ', tostring(layout.fontSizePt),
				'pt; line-height: ', tostring(layout.lineSpacing), '; }\n')
			writer('blockquote, .note, .caption { font-size: ',
				tostring(layout.specialFontSizePt), 'pt; line-height: ',
				tostring(layout.specialLineSpacing), '; }\n')
			writer('blockquote { margin-left: ', tostring(layout.longQuoteIndentCm),
				'cm; font-size: ', tostring(layout.specialFontSizePt),
				'pt; line-height: ', tostring(layout.specialLineSpacing), '; }\n</style>\n')
			writer('</head><body>\n')
		end,
