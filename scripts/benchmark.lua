...
time("Save .wp file", function() Cmd.SaveCurrentDocumentAs("/tmp/temp.wp") end)
print("(size of file: "..getfilesize("/tmp/temp.wp")..")")
...
Cmd.LoadDocumentSet("/tmp/temp.wp")
Cmd.SaveCurrentDocumentAs("/tmp/temq.wp")
if (getfilesize("/tmp/temp.wp") ~= getfilesize("/tmp/temq.wp")) then
